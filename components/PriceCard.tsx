...
export default function PriceCard({ title, code, price, isSelected, onClick }: PriceCardProps) {
  return (
    <div 
      onClick={onClick}
      className={`relative p-5 rounded-2xl cursor-pointer transition-all duration-200 overflow-hidden ${isSelected ? "bg-gray-800 ring-2 ring-gray-600" : "bg-[#1c1c1e] hover:bg-gray-800"}`}
    >
